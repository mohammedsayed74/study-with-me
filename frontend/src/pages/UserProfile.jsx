...
const UserProfile = () => {
    ...
    if (loading) {
        return (
            <div className="materials-page flex-center-wrapper" style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh" }}>
    ...
    return (
        <div style={{ 
            ...
            <div style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem", backgroundColor: "#fff" }}>
                ...
                {/* Form Grid */}
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem", rowGap: "1.5rem", marginBottom: "3.5rem" }}>
                    
                    {/* Full Name */}
                    <div>
                        <label style={{ display: "block", marginBottom: "0.6rem", color: "#444", fontWeight: "600", fontSize: "0.9rem" }}>Full Name</label>
                        <input 
                            type="text" 
                    ...
                    {/* Nick Name */}
                    <div>
                        <label style={{ display: "block", marginBottom: "0.6rem", color: "#444", fontWeight: "600", fontSize: "0.9rem" }}>Nick Name</label>
                        <input 
                            type="text" 
                    ...
                    {/* Gender */}
                    <div>
                        <label style={{ display: "block", marginBottom: "0.6rem", color: "#444", fontWeight: "600", fontSize: "0.9rem" }}>Gender</label>
                ...
                <div>
                    <h3 style={{ fontSize: "1.1rem", color: "#222", marginBottom: "1.5rem", fontWeight: "700" }}>My email Address</h3>
                    ...
                    <div style={{ display: "flex", alignItems: "center", marginBottom: "2rem" }}>
                        <div style={{
                            ...
                            <span className="material-symbols-outlined" style={{ color: "#3B82F6", fontSize: "1.3rem" }}>mail</span>
                        </div>
                        <div>
                            <div style={{ color: "#222", fontWeight: "500", fontSize: "0.95rem" }}>{email}</div>
                            <div style={{ color: "#888", fontSize: "0.85rem", marginTop: "0.2rem" }}>1 month ago</div>
                        </div>
                    </div>
                </div>
